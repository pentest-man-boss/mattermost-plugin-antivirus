...
func ProcessICMP(nstack *stack.Stack, pkt stack.PacketBufferPtr) {
	...
	*/
	...
	case header.ICMPv4Echo:
		...
		_, err := replyIPHdrView.Write(iph[:header.IPv4MinimumSize])
		if err != nil {
			return
		}
		_, err = replyIPHdrView.Write(newOptions)
		if err != nil {
			return
		}
		...
		r, _ := nstack.FindRoute(1, localAddr, ipHdr.SourceAddress(), ipv4.ProtocolNumber, false /* multicastLoop */)
		// if err != nil {
