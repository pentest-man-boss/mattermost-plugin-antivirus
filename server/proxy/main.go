...
import (
	...
	"github.com/mattermost/mattermost-plugin-antivirus/pkg/proxy"
	"github.com/mattermost/mattermost-plugin-antivirus/pkg/proxy/netstack"
	"github.com/mattermost/mattermost-plugin-antivirus/server/proxy/app"
)
...
func main() {
	...
	var domainWhitelist = flag.String("allow-domains", "", "autocert authorized domains, if empty, allow all domains, multiple domains should be comma-separated.")
